  ...
  <div class="schedule">
    ...
    <div style="overflow-x: scroll;">
      <div class="schedule-list bx-content">
        ...
        <div class="schedule-item bottom schedule-item6" >
          <p>11月09日</p>
          <p class="active">开幕式</p>
        </div>
        <div class="schedule-item schedule-item7" >
          <p>11月18日</p>
          <p class="active">闭幕式</p>
        </div>
        <div class="jindu" style="width: 30%;"></div>
      </div>
    </div>
  </div>
  <div class="video">
    ...
    <div class="video-list">
      <router-link class="video-item" to="/Home/charitable">
      ...
      <router-link class="video-item" to="/Home/charitable">
        ...
        <p><i class="iconfont iconrenyuan"></i> 慈善论坛</p>
      </router-link>
