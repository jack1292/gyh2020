<template>
    <div class="warpper">
        ...
        <div class="desc">
            <div>
                <img src="../../../assets/img/img_temp_desc_2.png"/>
            </div>
            <div class="org-desc">
                <p>{{ userinfo.name }} ，
        ...
        <!--<div class="title">-->
        <!--<img src="../../../assets/img/img_temp_project_2.png"/>-->
        <!--</div>-->
        ...
        <div class="mien-project">
            <div class="title">
                <img src="../../../assets/img/img_temp_mien_2.png"/>
            </div>
            <div class="org-project-list">
        ...
        <div class="contact-us">
            <div class="title">
                <img src="../../../assets/img/img_temp_about_2.png"/>
            </div>
            <div class="item-container">
                <img class="item-img" src="../../../assets/img/img_lianxiren2.png"/>
            ...
            <div class="item-container">
                <img class="item-img" src="../../../assets/img/img_address2.png"/>
                <div class="item-content">
...
<style scoped lang="scss">
    ...
    .warpper {
        ...
        .org-logo {
            ...
            height: 120px;
            padding: 0 20px;
            background-image: url("../../../assets/img/img_temp_bg_2.png");
            div {
                display: flex;
                align-items: center;
                img {
