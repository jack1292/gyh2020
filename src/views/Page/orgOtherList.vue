<template>
    <div class="organization-warpper">
        ...
        <div class="type-item" v-if="list.length>0">
            <div class="org-list">
                <router-link :to="'/Content/template'+item.shop_id+'?id=' + item.user_id" class="org-item"
...
<script>
    import {getOrgOtherList} from "@/api";
    ...
    export default {
        ...
        methods: {
            async getList() {
                let _data = await getOrgOtherList(1, 10000, this.keyword,1)
