<template>
    <div class="warrper">
        <img class="banner" src="../../../assets/img/bg_special3.png"/>
        <img class="classify-title" src="../../../assets/img/special_desc3.png"/>
        <div class="desc">
        ...
        <img class="classify-title" src="../../../assets/img/special_mine3.png"/>
        <div class="mine-list">
