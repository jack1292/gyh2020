<template>
    <div class="project-detail">
        ...
        <div class="detail-info">
            ...
            <p class="detail-desc" v-for="item in xiangmu_desc" :key="item">{{ item }}</p>
        </div>
        ...
        <div class="about-box">
            ...
            <div class="about-list">
                <router-link class="about-item" :to="'/Content/projectDetail?id=' + item.id"
                             v-for="(item,index) in relevant" :key="index">
                    <div>
